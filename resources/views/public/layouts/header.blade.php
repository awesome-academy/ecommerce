            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop">
                    <div class="left-header">
                        <div class="logo">
                            <a href="{{ route('index') }}"><img src="{{ config('setting.image_folder_icons') }}/logochau.png" alt="IMG-LOGO"></a>
                        </div>
                    </div>
                            ...
                            <div class="wrap-icon-header flex-w flex-r-m h-full wrap-menu-click p-t-8">
                                <div class="h-full flex-m">
                                    <div class="icon-header-item flex-c-m trans-04 js-show-modal-search" id="d-s">
                                        <img src="{{ config('setting.image_folder_icons') }}/icon-search.png" alt="SEARCH">
                                    </div>
                                </div>
                                @guest
                                <div class="wrap-cart-header h-full flex-m m-l-10 menu-click">
                                    <div id="icon-login" class="icon-header-item flex-c-m trans-04" >
                                        <img src="{{ config('setting.image_folder_icons') }}/icon-login.png" alt="login">
                                    </div>
                                ...
                                <div class="wrap-cart-header h-full flex-m m-l-10 menu-click">
                                    <div class="icon-header-item flex-c-m trans-04" id="icon-user">
                                        <img src="{{ config('setting.pathicon') }}/icon-user.png" alt="user">
                                    </div>
                                    <div class="cart-header menu-click-child trans-04">
                                        @if((Auth::user()->role) == 'Admin')
                                        <a href="{{ url('Admin') }}" class=" flex-c-m txt-s-101 cl9 hov-cl10 trans-04"><p>{{ Auth::user()->role }}</p> </a><br/>
                                        @else
                    ...
                    <div class="container-search-header" id="desktop-search" >
                        {{ Form::open(['route' => 'search', 'method' => 'get', 'class' => 'wrap-search-header flex-w']) }}
                        <button class="flex-c-m trans-04">
                            <span class="lnr lnr-magnifier"></span>
                        </button>
                        {{ Form::text('key', '', ['placeholder' => 'Search', 'class' => 'plh1']) }}
                        {{ Form::close() }}
                    </div>
                </div>
            </header>
