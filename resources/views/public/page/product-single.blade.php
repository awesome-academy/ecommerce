        ...
        <div class="container">
                            ...
                            <div class="wrap-main-pic-100 bo-all-1 bocl12 pos-relative">
                                <div class="main-frame">
                                    <div class="wrap-main-pic">
                                        <div class="main-pic">
                                            <img src="source/images/pro-detail-01.jpg" alt="IMG-SLIDE">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="wrap-thumb-100 flex-w flex-sb p-t-30">
                                <div class="thumb-100">
                                    <div class="sub-frame sub-1">
                                        <div class="wrap-main-pic">
                                            <div class="main-pic">
                                                <img src="source/images/pro-detail-thumb-02.jpg" alt="IMG-SLIDE">
                                            </div>
                                        </div>
                                ...
                                <div class="thumb-100">
                                    <div class="sub-frame sub-2">
                                        <div class="wrap-main-pic">
                                            <div class="main-pic">
                                                <img src="source/images/pro-detail-thumb-03.jpg" alt="IMG-SLIDE">
                                            </div>
                                        </div>
                                ...
                                <div class="thumb-100">
                                    <div class="sub-frame sub-3">
                                        <div class="wrap-main-pic">
                                            <div class="main-pic">
                                                <img src="source/images/pro-detail-thumb-04.jpg" alt="IMG-SLIDE">
                                            </div>
                                        </div>
            ...
            <div class="tab02 p-t-80">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#info" role="tab">chi tiết</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="p-t-36">
                            ...
                            <div class="flex-w flex-sb-t bo-b-1 bocl15 p-b-37">
                                <div class="wrap-pic-w size-w-56">
                                    <img src="source/images/avatar-03.jpg" alt="AVATAR">
                                </div>
                            ...
                            <form class="w-full p-t-42">
                                ...
                                <div class="row p-t-12">
                                    <div class="col-sm-6 p-b-30">
                                        <input class="txt-s-101 cl3 plh1 size-a-25 bo-all-1 bocl11 focus1 p-rl-20" type="text" name="name" placeholder="Tên *">
                                    </div>
                                    <div class="col-sm-6 p-b-30">
                                        <input class="txt-s-101 cl3 plh1 size-a-25 bo-all-1 bocl11 focus1 p-rl-20" type="text" name="email" placeholder="Email *">
                                    </div>
                                    <div class="col-12 p-b-30">
                                        <textarea class="txt-s-101 cl3 plh1 size-a-26 bo-all-1 bocl11 focus1 p-rl-20 p-tb-10" name="review" placeholder="Review của bạn *"></textarea>
                                    </div>
                                </div>
                                <div class="flex-r">
